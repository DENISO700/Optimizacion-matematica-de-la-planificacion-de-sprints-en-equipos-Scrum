...
Este proyecto presenta la **optimización de un problema de programación lineal de tipo asignación**, utilizando programacion lineal.  
...
- Aplicación del solver **GAMS** para encontrar soluciones óptimas.  
